...
# Resumely — Directory Submission Pack v1
...
## Core Copy Block (reuse across all directories)

These are the canonical assets. Most directories accept a subset of these fields — copy from here and trim as needed.
...
```
Check your job fit, tailor your resume, export from iPhone.
```
...
Free to use. No subscription required while v1.2 validates the activation flow.
...
```
AI Tools, Career, Productivity, Resume, Job Search, iOS App, Mobile App
```
...
### Logo / Icon
```
Use the Resumely app icon from App Store Connect assets (1024×1024 PNG).
...
## Batch 1 — 5 Directories

### 1. Futurepedia (futurepedia.io)

- **Category fit**: 5/5 — AI tools directory; career category active
- **Effort**: low (web form)
- **Cost**: free
...
- **Category fit**: 5/5 — AI tools directory; resume/career category
- **Effort**: low
- **Cost**: free
- **Backlink quality**: high
- **Status**: not started
...
|---|---|
| Tool name | Resumely |
| One-liner | Check your job fit, tailor your resume, export from iPhone |
...
### 5. Launching Next (launchingnext.com)

- **Category fit**: 4/5 — launch-focused; good for new apps
- **Effort**: low
- **Cost**: free
- **Backlink quality**: medium
- **Status**: not started
- **Note**: Frame as "now live" momentum, not launch-day — the app went live 2026-06-19 (RunSmart) / has been iterating since; Resumely v1.2 went live 2026-06-29
...
| Tagline | Check your job fit, tailor your resume, export from iPhone |
