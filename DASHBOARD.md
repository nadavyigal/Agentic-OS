...
| --- | --- | --- | --- | --- | --- |
| RunSmart iOS | PHASE 2 — Release 1.0.8 (22) (WP-37/38/40 bundle) | Confirm ASC upload processing; TestFlight smoke; re-run WP-42 on clean 1.0.8 cohort after users onboard | Yes | Fresh | Medium |
...
| Agentic OS | Advanced OS patterns lean pilot | Merge PR #27, then run ./agentic-os morning once to confirm the reconciled pipeline regenerates dashboards AND fires the daily-note habit end to end. (Older: PR #25 Portfolio HQ v3 still open.) | Yes | Fresh | High |
