...
- Never store secrets, credentials, customer data, or production data.
- A checkpoint is context, not a decision. Founder approval is required before
  promoting content into decisions, plans, skills, or active work packets.

The Command Center surfaces checkpoints automatically after
`./agentic-os refresh`.
