...
- [x] Free vs paid feature matrix per app — `WP-2-monetization-spec.md` Section 1.
- [x] Paywall placement spec (which screen, which trigger event) — `WP-2-monetization-spec.md` Section 2.
- [x] PostHog events needed to read activation → paywall conversion — `WP-2-monetization-spec.md` Section 3.
- [x] StoreKit / IAP product IDs drafted (no prices committed) — `WP-2-monetization-spec.md` Section 4.
- [x] Price experiment plan (A/B once there is traffic) — `WP-2-monetization-spec.md` Section 5.

## Research outputs
- Competitor pricing research: `research/WP-2-competitor-pricing-research.md`
- Full CFO spec: `WP-2-monetization-spec.md`
