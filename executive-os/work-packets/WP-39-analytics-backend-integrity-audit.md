...
- **D2 — DECIDED 2026-07-09 (EXD-020):** Issue: Garmin's Developer Portal OAuth app is de-approved by Garmin itself since 2026-07-02, causing all 9 currently-connected users to sit in `reauth_required`; the fix is a bounded resubmission (tied to WP-24), not open-ended repair. Decision was whether to pull that resubmission out of EXD-015's park now (since it doesn't compete with Resumely for founder attention the way "fix Garmin" as a vague blob would) or hold the full park until 2026-08-01. **Founder reconfirmed the full park** — accepting that the 9 existing users stay broken past 08-01, likely into September once Garmin's own review turnaround stacks on top. See EXD-020.
