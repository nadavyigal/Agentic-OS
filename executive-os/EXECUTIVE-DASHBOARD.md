...
7. Research (2026-07-11): right-user demand-mining brief filed at `executive-os/research/2026-07-11-demand-mining-right-user-fit.md` — sourced ASO hook (73% C25K non-completion, 10%-weekly-jump injury rule) ready to fold into RunSmart copy; flags Resumely's Match Score defensibility work as directly relevant to a named community complaint pattern ("gameable" ATS scores).
