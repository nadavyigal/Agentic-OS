...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| RunSmart iOS | PHASE 2 — Activation diagnostics + Garmin maintenance (EXD-015) | Re-run PostHog funnel on **2026-07-08+** for build-21-only users (`filterTestAccounts=true`). Founder: decide WP-34 re-implement vs park. Then WP-27 Gate-4 screenshots if Garmin path resumes | 2 | Yes (35) | Fresh | High | tasks/progress.md | 2026-07-05 81bd11b Ship 1.0.7 (21) — WP-15 first-run activation fix live |
| Resumely iOS | Post-launch — WP-36 export-friction diagnostic live; awaiting 1.3 (8) production funnel data | After 1.3 (8) is live, re-run PostHog dashboard `1801425` / insight `lVFdiDCs`; if `optimization_completed` without `optimized_viewed`, investigate tab-routing before export UX | 2 | No | Fresh | High | tasks/progress.md | 2026-07-05 214826f Ship 1.3 (8) — WP-36 export-visibility instrumentation, smoke-tested live |
...
| Agentic OS | Advanced OS patterns lean pilot | Use the Resumely submission loop in two COO reviews; optionally add GLOBAL-OUTPUT-CONTRACT.md (deferred from the prompt study); add no further loop cards unless current and non-duplicative | 0 | Yes (1) | Fresh | High | tasks/progress.md | 2026-07-05 c2d0fc8 WP-18/30/36: canonicalize resume_uploaded, add export-friction diagnostic; WP-31 Hebrew ASO packet; EXD-019 parks WP-34 |
...
- Agentic OS: validated 2026-06-12, last commit 2026-07-05 c2d0fc8 WP-18/30/36: canonicalize resume_uploaded, add export-friction diagnostic; WP-31 Hebrew ASO packet; EXD-019 parks WP-34
...
Packet states that may make the dashboard misleading:
...
Resumely iOS: After 1.3 (8) is live, re-run PostHog dashboard `1801425` / insight `lVFdiDCs`; if `optimization_completed` without `optimized_viewed`, investigate tab-routing before export UX
...
- RunSmart iOS: 29 saved plan(s) — latest "Build 18 ASC Submission + Garmin Brand Compliance Resend — 2026-06-26" (2026-06-26). See Saved Plans.
...
- Resumely iOS: backend/state gaps unchanged (paste-text diagnosis, NWPathMonitor auto-resume, etc.)
...
- RunSmart iOS: docs/specs/demo-mode-simulator-recording 2.md
...
- RunSmart iOS: docs/specs/wp25-garmin-track 2.md
...
- RunSmart iOS: docs/superpowers/plans/2026-06-18-build15-resubmit-cleanup 2.md
- RunSmart iOS: docs/superpowers/plans/2026-06-18-build15-resubmit-cleanup.md
- RunSmart iOS: docs/superpowers/plans/2026-06-26-build18-asc-submission-and-garmin-resend 2.md
