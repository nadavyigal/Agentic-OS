...
| Agentic OS | Advanced OS patterns lean pilot | Finish dashboard-trust reconciliation, push Agentic OS main, then use the refreshed one-move recommendation for today's work | 0 | Yes (15) | Fresh | Medium | tasks/progress.md | 2026-07-15 f258bcf4 Merge branch 'main' into dashboard/ftux-submissions-and-artifacts |
...
- Agentic OS: validated 2026-07-13, last commit 2026-07-15 f258bcf4 Merge branch 'main' into dashboard/ftux-submissions-and-artifacts
...
- [RunSmart iOS] worktree on claude/runsmart-1-0-9-verification-f8e8a2 at /Users/nadavyigal/Documents/Projects /IOS RunSmart light /IOS RunSmart app/.claude/worktrees/runsmart-1-0-9-verification-f8e8a2 -> Land or discard this worktree, then `git worktree remove` it.
...
- [Resumely iOS] worktree on claude/release-b-story-8, 1 uncommitted file(s) at /Users/nadavyigal/Documents/Projects /ResumeBuilder/ResumeBuilder IOS APP/.claude/worktrees/resumely-release-a-b-landing-325d9a -> Land or discard this worktree, then `git worktree remove` it.
...
- [Agentic OS] dashboard/ftux-submissions-and-artifacts: 2 unpushed commit(s), last commit 2026-07-15 -> Push dashboard/ftux-submissions-and-artifacts and open a PR, or explicitly hand it off.
...
- Resumely iOS: worktree:claude/release-b-story-8:tasks/MEMORY.md
- Resumely iOS: worktree:claude/release-b-story-8:tasks/lessons.md
- Resumely iOS: worktree:claude/release-b-story-8:tasks/progress.md
- Resumely iOS: worktree:claude/release-b-story-8:tasks/session-log.md
- Resumely iOS: worktree:claude/release-b-story-8:tasks/todo.md
...
- RunSmart iOS: worktree:claude/runsmart-1-0-9-verification-f8e8a2:tasks/ERRORS.md
- RunSmart iOS: worktree:claude/runsmart-1-0-9-verification-f8e8a2:tasks/MEMORY.md
- RunSmart iOS: worktree:claude/runsmart-1-0-9-verification-f8e8a2:tasks/lessons.md
- RunSmart iOS: worktree:claude/runsmart-1-0-9-verification-f8e8a2:tasks/progress.md
- RunSmart iOS: worktree:claude/runsmart-1-0-9-verification-f8e8a2:tasks/session-log.md
- RunSmart iOS: worktree:claude/runsmart-1-0-9-verification-f8e8a2:tasks/todo.md
